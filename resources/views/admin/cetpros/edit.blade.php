...
@section('content')
    <div class="row">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.cetpros.update', $cetpro) }}" method="POST" id="formulario">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="form-row">
                    ...
                    <div class="card">
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" min="0" class="form-control" id="telefono" name="telefono" value="{{$cetpro->telefono}}" required
